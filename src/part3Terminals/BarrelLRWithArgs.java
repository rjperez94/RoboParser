...
public class BarrelLRWithArgs implements Operation {

	private Operation value1 ;
	private String sens1 = "";
	

	public BarrelLRWithArgs(Scanner s) {
		// TODO Auto-generated constructor stub
		if (!parseLeft(s)) {
			throw new ParserFailureException("Failed parsing BarrelLR Argument"); 
		}
	}
