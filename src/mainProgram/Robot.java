...
public class Robot {
    ...
    public Robot(World world, int x, int y, String colour, Path assetPath) {
        this.world = world;
        this.x = x;
        this.y = y;
        this.colour = colour;
        ...
        targetFuel = fuel;
        try {
            robotImage1 = ImageIO.read(new File(assetPath.toAbsolutePath() + "/robot_" + colour + "_1.png"));
            robotImage2 = ImageIO.read(new File(assetPath.toAbsolutePath() + "/robot_" + colour + "_2.png"));
            shieldImage = ImageIO.read(new File(assetPath.toAbsolutePath() + "/shield.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
