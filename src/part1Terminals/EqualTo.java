...
public class EqualTo implements Operation {
	private Operation value1 ;
	private Operation value2 ;
	private String sens1 = "";
	private String sens2 = "";
	
	public EqualTo(Scanner s) {
		if (!parseLeft(s) || !s.next().equals(",") || !parseRight(s)) {
			throw new ParserFailureException("Failed parsing Equal To Operation"); 
		}
	}
